            ...
            <div class="formbg-inner padding-horizontal--48">
              ...
              <div class="form-part">
                  <div class="field paddings-input">
                    <label >Libelle</label>
                    <input type="text" name="Libelle" value="<?php  echo $don[0]['Libelle']; ?>">
                  </div>
              ...
              <div class="form-part">
                <div class="field paddings-input">
                  ...
                  <input  name="paiement" value="<?php   echo $don[0]['Montant']; ?>" required>
                </div>
                <div class="paddings-input">
                ...
                <div class="field paddings-input">
                  ...
                  <input  type="date" name="date" value="<?php   echo $don[0]['date']; ?>">
                </div>
              </div>
              ...
              <div class="form-part">
                <div class="field paddings-input">
                  ...
                  <input type="text" name="com" value="<?php  echo $don[0]['commentaire']; ?>">
                </div>
